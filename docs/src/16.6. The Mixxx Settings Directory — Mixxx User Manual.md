---
title: "16.6. The Mixxx Settings Directory — Mixxx User Manual"
source: "https://manual.mixxx.org/2.5/en/chapters/appendix/settings_directory"
author:
published:
created: 2026-06-17
description:
...
All controller mappings you stored. This can be downloaded and [self-built mappings](https://manual.mixxx.org/2.5/en/chapters/advanced_topics#advanced-controller), as well as built-in mappings that you modified in Preferences > Controllers > YourController manually or with the MIDI Wizard.
